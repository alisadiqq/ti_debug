...
GPIO_PinConfig gpioPinConfigs[26] = {
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_FALLING | GPIO_CFG_PULL_NONE_INTERNAL, /* CONFIG_GPIO_Increment */
...
const uint_least8_t CONFIG_GPIO_Increment_CONST = CONFIG_GPIO_Increment;
